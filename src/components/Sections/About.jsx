...
const aboutData = {
  ...
  aboutMe:
    "I am Muhammad Zubair, web developer from Lahore, Pakistan. I have rich experience in web site front end building and customization, also I am good at Nodejs",
};
